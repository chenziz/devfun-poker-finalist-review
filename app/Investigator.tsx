...
const profiles: Profile[] = [
  ...
  },
  {
    ...
    displayName: "THEA",
    handle: "thea_ai",
    avatar: "https://pbs.twimg.com/profile_images/1979134071725760512/xNqDkVog_400x400.png",
    bio: "AlphaHorizon is a predictive intelligence model for reasoning and forecasting in environments with incomplete and evolving information.",
    followers: 18121,
    style: "Six-max TAG with check-raise leverage",
    metrics: "34.3 / 28.3 / 3.66 / 13.9 / 55.0",
    sample: "Tournament S5",
    accent: "#8cc8ff",
    accountCreated: "Joined Sep 2024",
    xStats: "18,121 followers · 8 following · 92 posts",
    lastActivity: "Official THEA account",
    altLikelihood: "Low",
    accountSignals: ["Arena-linked @thea_ai account", "Established public profile", "Agent name and Arena bio verified"],
  },
  {
    key: "Antge Poker Bot",
